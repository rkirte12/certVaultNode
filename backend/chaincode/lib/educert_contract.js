...
class EducertContract extends Contract {
    ...
    async initLedger(ctx) {
        ...
        let schemaCertificate = new Schema("university degree", "v1", ["roll_Num","first_Name","last_Name","certificate_Num","year_of_Passing","national_ID","document_Type","programs","department","streams","doc_URL","universityEmail", "universityName"] );
     ...
     * @param {String} certificate_Num - UUID for a certificate (automatically generated. Must match with database entry)
     ...
     */
    async issueCertificate(ctx, certHash, universitySignature, studentSignature, roll_Num,first_Name,last_Name,certificate_Num,year_of_Passing,national_ID,document_Type,programs,department,streams,doc_URL,universityEmail, unversityName, universityPK, studentPK) {
        ...
        await ctx.stub.putState("CERT" + certificate_Num    , Buffer.from(JSON.stringify(certificate)));
